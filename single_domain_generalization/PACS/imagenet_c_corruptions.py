...
def frost(x, severity=1):
    ...
    root = "path/frost"
    filename = [root+'/frost1.png', 
                root+'/frost2.png', root+'/frost3.png', root+'/frost4.jpg', root+'/frost5.jpeg', root+'/frost6.jpeg'][idx]
...
CORRUPTIONS = [frost, gaussian_noise, shot_noise, impulse_noise,
               fog, brightness, contrast,
               gaussian_blur, defocus_blur, zoom_blur]

CORRUPTIONS_few = [gaussian_noise]
