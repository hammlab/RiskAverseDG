...
from utils import load_PACS_sources, load_PACS_targets, eval_accuracy
import argparse
...
src_data_loaders_1, val_data, val_labels = load_PACS_sources(SRCS, BATCH_SIZE)
src_data_loaders_2, _, _ = load_PACS_sources(SRCS, NUM_STYLES)
...
def train_step_min_erm(processed_content_data, content_labels, content_data, style_data):
    ...
    with tf.GradientTape(persistent=True) as tape:
        ...
        smoothed_loss = 5*loss_2 + 0.5 * loss_4 + loss_3 + loss_1
