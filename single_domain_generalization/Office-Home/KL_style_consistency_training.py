...
from utils import load_office_home_sources, load_office_home_targets, eval_accuracy
import argparse
...
src_data_loaders_1, val_data, val_labels = load_office_home_sources(SRCS, BATCH_SIZE)
src_data_loaders_2, _, _ = load_office_home_sources(SRCS, NUM_STYLES)
