...
from utils import eval_accuracy, load_VLCS_sources, load_VLCS_targets, restore_original_image_from_array_vgg, plot_images
...
src_data_loaders_content, val_data, val_labels = load_VLCS_sources(SRCS, BATCH_SIZE)
src_data_loaders_style, _, _ = load_VLCS_sources(SRCS, NUM_STYLES)
...
def train_step_style_consistency(processed_content_data,content_labels_1, content_data_1, style_data_1):
    ...
    with tf.GradientTape(persistent=True) as tape:
        ...
        smoothed_loss = loss_3 + 2*loss_2 + 0.5 * loss_4 + loss_1
